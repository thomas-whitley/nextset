...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontFamily: 'ArchivoNarrow-Bold', color: Colors.light.text },
  sectionHint: { fontSize: 13, fontFamily: 'Archivo-Regular', color: Colors.light.textTertiary, marginBottom: 12, lineHeight: 18 },
  changeProgramButton: { backgroundColor: Colors.light.primaryLight, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 14 },
  changeProgramText: { fontSize: 14, fontFamily: 'ArchivoNarrow-SemiBold', color: Colors.light.primary },
  ...
  programBannerText: { fontSize: 13, fontFamily: 'Archivo-Medium', color: '#EEF0ED' },
  programContent: { padding: 16 },
  programName: { fontSize: 18, fontFamily: 'ArchivoNarrow-Bold', color: Colors.light.text, marginBottom: 4 },
  programDescription: { fontSize: 14, fontFamily: 'Archivo-Regular', color: Colors.light.textSecondary, lineHeight: 20, marginBottom: 12 },
  ...
  dayTagText: { fontSize: 12, fontFamily: 'Archivo-Medium', color: Colors.light.primary },
  programFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  statText: { fontSize: 13, fontFamily: 'Archivo-Medium', color: Colors.light.textTertiary },
  ...
  emptyHistoryText: { fontSize: 16, fontFamily: 'ArchivoNarrow-SemiBold', color: Colors.light.text, marginBottom: 4 },
  emptyHistorySubtext: { fontSize: 14, fontFamily: 'Archivo-Regular', color: Colors.light.textTertiary, textAlign: 'center' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20 },
  modalContent: { backgroundColor: Colors.light.card, borderRadius: 20, padding: 24, width: '100%', maxWidth: 400 },
  modalTitle: { fontSize: 20, fontFamily: 'ArchivoNarrow-Bold', color: Colors.light.text, marginBottom: 12 },
  modalText: { fontSize: 15, fontFamily: 'Archivo-Regular', color: Colors.light.textSecondary, lineHeight: 22, marginBottom: 20 },
  ...
  modalCancelText: { fontSize: 16, fontFamily: 'ArchivoNarrow-SemiBold', color: Colors.light.textSecondary },
  modalConfirmText: { fontSize: 16, fontFamily: 'ArchivoNarrow-SemiBold', color: '#FFFFFF' },
});
