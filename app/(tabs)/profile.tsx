...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 30, fontFamily: 'Inter-Bold', color: Colors.light.primary },
  profileName: { fontSize: 24, fontFamily: 'Inter-Bold', color: Colors.light.text, marginBottom: 4 },
  profileUsername: { fontSize: 15, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary },
  section: { marginBottom: 28 },
  sectionTitle: { fontSize: 18, fontFamily: 'Inter-Bold', color: Colors.light.text, marginBottom: 12 },
  ...
  statValue: { fontSize: 18, fontFamily: 'Inter-Bold', color: Colors.light.text, marginBottom: 4 },
  statLabel: { fontSize: 12, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary, textAlign: 'center' },
  sinceText: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary, textAlign: 'center', marginTop: 12 },
  ...
  prExercise: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text },
  prDate: { fontSize: 12, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary, marginTop: 2 },
  prWeight: { fontSize: 16, fontFamily: 'Inter-Bold', color: Colors.light.primary },
  emptyState: { paddingVertical: 28, paddingHorizontal: 8, alignItems: 'center' },
  emptyTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text, marginBottom: 6 },
  emptyText: { fontSize: 14, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary, textAlign: 'center', lineHeight: 20, marginBottom: 16 },
  emptyButton: { backgroundColor: Colors.light.primaryLight, borderRadius: 12, paddingVertical: 10, paddingHorizontal: 20 },
  emptyButtonText: { fontSize: 14, fontFamily: 'Inter-SemiBold', color: Colors.light.primary },
});
