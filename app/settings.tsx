...
const styles = StyleSheet.create({
  ...
  profileInitial: { fontSize: 22, fontFamily: 'Inter-Bold', color: '#FFFFFF', textTransform: 'uppercase' },
  profileInfo: { flex: 1 },
  profileName: { fontSize: 18, fontFamily: 'Inter-SemiBold', color: Colors.light.text, marginBottom: 2 },
  profileEmail: { fontSize: 14, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary },
  section: { marginTop: 24 },
  sectionTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text, marginBottom: 12 },
  sectionNote: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary, marginTop: 8, marginLeft: 4 },
  settingsCard: {
    backgroundColor: Colors.light.card,
    borderRadius: 16,
    shadowColor: '#000',
  ...
  settingTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text, marginBottom: 2 },
  settingTitleDestructive: { color: Colors.light.error },
  settingSubtitle: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textSecondary },
  version: { fontSize: 14, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary, textAlign: 'center', marginTop: 32, marginBottom: 40 },
  ...
  modalTitle: { fontSize: 20, fontFamily: 'Inter-Bold', color: Colors.light.text, marginBottom: 20, textAlign: 'center' },
  ...
  modalOptionText: { fontSize: 16, fontFamily: 'Inter-Medium', color: Colors.light.text, textAlign: 'center' },
  modalOptionTextSelected: { color: Colors.light.primary, fontFamily: 'Inter-Bold' },
  modalCancelButton: { marginTop: 16, paddingVertical: 14, borderRadius: 12, backgroundColor: Colors.light.border },
  modalCancelText: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.textSecondary, textAlign: 'center' },
});
