...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontFamily: 'Inter-Bold', color: Colors.light.text },
  content: { flex: 1, paddingHorizontal: 20 },
  calendarHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 20 },
  monthTitle: { fontSize: 18, fontFamily: 'Inter-Bold', color: Colors.light.text },
  dayHeaders: { flexDirection: 'row', marginBottom: 8 },
  dayHeader: { flex: 1, textAlign: 'center', fontSize: 12, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary },
  ...
  dayText: { fontSize: 14, fontFamily: 'Inter-Regular', color: Colors.light.text },
  completedDayText: { fontFamily: 'Inter-SemiBold', color: Colors.light.primary },
  ...
  legendText: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary },
  workoutDetails: { backgroundColor: Colors.light.card, borderRadius: 16, padding: 16, marginBottom: 24 },
  workoutDetailsTitle: { fontSize: 14, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary, marginBottom: 8 },
  workoutSummary: { paddingVertical: 8, borderTopWidth: 1, borderTopColor: Colors.light.border },
  workoutName: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text },
  workoutMeta: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textSecondary, marginTop: 2 },
});
