...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 16, fontFamily: 'Inter-Regular', color: Colors.light.text, marginLeft: 12 },
  sectionHeader: {
    flexDirection: 'row',
  ...
  sectionTitle: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text },
  sectionCount: { fontSize: 14, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary },
  ...
  exerciseName: { fontSize: 16, fontFamily: 'Inter-SemiBold', color: Colors.light.text, marginBottom: 2 },
  exerciseDetail: { fontSize: 13, fontFamily: 'Inter-Regular', color: Colors.light.textSecondary, marginBottom: 2 },
  exerciseEquipment: { fontSize: 12, fontFamily: 'Inter-Medium', color: Colors.light.textTertiary },
  exerciseBadge: { backgroundColor: Colors.light.primaryLight, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  exerciseBadgeText: { fontSize: 11, fontFamily: 'Inter-SemiBold', color: Colors.light.primary },
  separator: { height: 8 },
  emptyState: { padding: 32, alignItems: 'center' },
  emptyStateText: { fontSize: 14, fontFamily: 'Inter-Regular', color: Colors.light.textTertiary, textAlign: 'center' },
});
